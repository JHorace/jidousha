...
pub struct PlayerCols {
    ...
    pub feed_count: __sdk::__query_builder::Col<Player, u64>,
    pub first_seen: __sdk::__query_builder::Col<Player, __sdk::Timestamp>,
}
...
impl __sdk::__query_builder::HasCols for Player {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        PlayerCols {
            ...
            feed_count: __sdk::__query_builder::Col::new(table_name, "feed_count"),
