...
/// The darker rule between bars.
pub const RULE: Color = hex(0x2c2740);
...
pub mod layers {
    /// The ground and the letterbox.
    pub const GROUND: i16 = -4;
...
/// The heading on the resolution takeover.
